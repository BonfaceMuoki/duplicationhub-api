        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('pages.index') }}" class="text-gray-700 hover:text-blue-600 transition duration-200">Pages</a>
                    <!-- <a href="{{ route('pages.search') }}" class="text-gray-700 hover:text-blue-600 transition duration-200">Search</a> -->
                    <a href="#" class="text-gray-700 hover:text-blue-600 transition duration-200">About</a>
                    <a href="{{ route('pages.index') }}" class="text-gray-700 hover:text-blue-600 transition duration-200">Contact</a>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="{{ route('pages.index') }}" class="hover:text-white transition-colors">Pages</a></li>
                        <li><a href="{{ route('pages.search') }}" class="hover:text-white transition-colors">Search</a></li>
