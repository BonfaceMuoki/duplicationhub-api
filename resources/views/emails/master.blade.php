...
<head>
    ...
    <title>@yield('title', 'DuplicationHub')</title>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="email-container">
                    ...
                    <tr>
                        <td class="email-header">
                            <img src="{{ asset('assets/emails/logo.png') }}" alt="DuplicationHub Logo" class="logo">
                            <h1 class="header-title">@yield('header_title', 'DuplicationHub')</h1>
                            <p class="header-subtitle">@yield('header_subtitle', 'Empowering Your Digital Success')</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-footer">
                            ...
                            <p class="footer-text">
                                © {{ date('Y') }} <a href="https://duplicationhub.ac.ke/" class="footer-link">DuplicationHub School</a>. All rights reserved.
                            </p>
