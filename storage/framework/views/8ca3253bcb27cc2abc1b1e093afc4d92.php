...
<head>
    ...
    <title><?php echo e($page->meta_title ?: $page->title); ?></title>
    <meta name="description" content="<?php echo e($page->meta_description ?: $page->summary); ?>">
        ...
        "@graph": [
            {
                ...
                "name": "<?php echo e(config('app.name', 'Duplication Hub')); ?>",
                "url": "<?php echo e(url('/')); ?>",
                "logo": {
                    "@type": "ImageObject",
                    "url": "<?php echo e(asset('favicon.ico')); ?>",
                    "width": 32,
                    "height": 32
                },
            ...
            {
                "@type": "Article",
                "@id": "<?php echo e(url()->current()); ?>#article",
                "headline": "<?php echo e($page->title); ?>",
                "description": "<?php echo e($page->meta_description ?: $page->summary); ?>",
                "image": {
                    "@type": "ImageObject",
                    "url": "<?php echo e($page->full_image_url ?: asset('assets/emails/email.png')); ?>",
                    "width": 1200,
                    "height": 630
                },
                "author": {
                    "@type": "Person",
                    "@id": "<?php echo e(url('/')); ?>#author",
                    "name": "<?php echo e($page->user ? $page->user->full_name : 'Admin User'); ?>",
                    "url": "<?php echo e(url('/')); ?>"
                },
                "publisher": {
                    "@id": "<?php echo e(url('/')); ?>#organization"
                ...
                "datePublished": "<?php echo e($page->created_at->toISOString()); ?>",
                "dateModified": "<?php echo e($page->updated_at->toISOString()); ?>",
                "articleSection": "Business Growth",
                "keywords": "business growth, referral marketing, lead generation, <?php echo e($page->title); ?>",
                "wordCount": "<?php echo e(str_word_count($page->summary ?? '') + str_word_count($page->body ?? '')); ?>",
                "inLanguage": "en-US",
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    },
                    {
                        ...
                        "position": 2,
                        "name": "Pages",
                        "item": "<?php echo e(route('pages.index')); ?>"
                    },
                    {
                        "@type": "ListItem",
                        "position": 3,
                        "name": "<?php echo e($page->title); ?>",
    ...
    <meta property="og:description" content="<?php echo e($page->meta_description ?: $page->summary); ?>">
    <meta property="og:image" content="<?php echo e($page->og_image_url ?: $page->full_image_url ?: asset('assets/emails/email.png')); ?>">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:type" content="article">
    <meta property="og:site_name" content="<?php echo e(config('app.name', 'Duplication Hub')); ?>">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($page->meta_title ?: $page->title); ?>">
    <meta name="twitter:description" content="<?php echo e($page->meta_description ?: $page->summary); ?>">
    <meta name="twitter:image" content="<?php echo e($page->og_image_url ?: $page->full_image_url ?: asset('assets/emails/email.png')); ?>">
    <?php
...
<?php $__env->startSection('additional_meta'); ?>
    <!-- Article specific meta tags -->
    <meta property="article:published_time" content="<?php echo e($seoData['published_time']); ?>">
    <meta property="article:modified_time" content="<?php echo e($seoData['modified_time']); ?>">
    <meta property="article:author" content="<?php echo e($seoData['author']); ?>">
    <meta property="article:section" content="<?php echo e($seoData['article_section'] ?? 'Business'); ?>">
    
    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($seoData['title']); ?>">
    <meta name="twitter:description" content="<?php echo e($seoData['description']); ?>">
    <meta name="twitter:image" content="<?php echo e($seoData['og_image']); ?>">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="<?php echo e(route('pages.index')); ?>" class="text-sm font-medium text-gray-500 hover:text-blue-600 transition-colors duration-200">
                        Pages
                    </a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-sm font-semibold text-gray-900"><?php echo e($page->title); ?></span>
                </div>
            </li>
        </ol>
    </nav>
...
<!-- <header class="bg-gradient-to-br from-gray-50 to-white shadow-lg border-b border-gray-200">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-[#000080] mb-6 leading-tight"><?php echo e($page->title); ?></h1>
            <?php if($page->headline): ?>
                <p class="text-xl md:text-2xl text-[#808080] mb-8 max-w-3xl mx-auto leading-relaxed"><?php echo e($page->headline); ?></p>
            <?php endif; ?>
            <div class="flex items-center justify-center space-x-6 text-sm text-gray-600 bg-white/70 backdrop-blur-sm rounded-full px-6 py-3 shadow-sm">
                ...
                <?php if($page->user): ?>
                    <span class="flex items-center">
                        ...
                        <?php echo e($page->user->full_name); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-8 space-y-6">
                <?php if($page->image_url || $page->video_url): ?>
                    <!-- Media Section -->
                        ...
                        <?php if($page->video_url): ?>
                            ...
                            <div>
                                <div class="relative aspect-video rounded-xl shadow-md overflow-hidden">
                                    <?php if(filter_var($page->video_url, FILTER_VALIDATE_URL) && (str_contains($page->video_url, 'youtube.com') || str_contains($page->video_url, 'youtu.be'))): ?>
                                        <iframe 
                                            src="<?php echo e(str_replace('watch?v=', 'embed/', str_replace('youtu.be/', 'youtube.com/embed/', $page->video_url))); ?>?rel=0&modestbranding=1" 
                                            title="<?php echo e($page->title); ?> Video"
                                            class="w-full h-full"
                                            frameborder="0" 
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <?php if($page->views > 0): ?>
                            <div class="flex items-center text-gray-600">
                                ...
                                <span><?php echo e($page->views); ?> <?php echo e(Str::plural('view', $page->views)); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div> -->
                ...
                <a href="https://web.whatsapp.com/send?phone=254740857767&text=<?php echo e(rawurlencode('Hi! I found you through ' . $page->title . ' - ' . url()->current())); ?>"
            ...
            <?php else: ?>
                <a href="https://wa.me/254740857767?text=<?php echo e(rawurlencode('Hi! I found you through ' . $page->title . ' - ' . url()->current())); ?>"
                   target="_blank" rel="noopener noreferrer"
                   class="inline-flex items-center justify-center px-8 py-4 bg-green-500 text-white font-bold rounded-xl hover:bg-green-600 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                    <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488"/>
            ...
            <?php endif; ?>
                        <a href="<?php echo e(route('pages.index')); ?>" class="block w-full text-center px-4 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors duration-200">
                            Browse More
                        </a>
                ...
                <?php if($page->summary): ?>
                    <div class="bg-gradient-to-r from-gray-50 to-white border-l-4 border-[#87CEEB] p-8 mb-12 rounded-r-lg shadow-sm">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <p class="text-xl text-[#000080] font-semibold leading-relaxed"><?php echo e($page->summary); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <div class="mt-16 pt-12 border-t border-gray-200" id="social-share">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://twitter.com/intent/tweet?text=<?php echo e(urlencode($page->title)); ?>&url=<?php echo e(urlencode(url()->current())); ?>" 
                           target="_blank" rel="noopener noreferrer"
                ...
                <div class="mt-16 p-8 bg-gradient-to-r from-gray-50 to-white rounded-2xl shadow-lg border border-gray-200">
                    <div class="flex items-center space-x-6">
                        <div class="w-20 h-20 bg-gradient-to-br from-[#000080] to-[#87CEEB] rounded-full flex items-center justify-center shadow-lg">
                            <span class="text-[#FFFFFF] text-2xl font-bold"><?php echo e(substr($page->user->first_name, 0, 1)); ?></span>
                        </div>
                        <div class="flex-1">
                            <h4 class="text-2xl font-bold text-[#000080] mb-2"><?php echo e($page->user->full_name); ?></h4>
    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <form id="interestForm" class="space-y-6" action="/leads/submit" method="POST">
                ...
                <input type="hidden" name="ref" value="<?php echo e(request()->get('ref', 'direct')); ?>">
                <input type="hidden" name="source" value="interest_modal">
                
                <!-- UTM Tracking Fields -->
                <input type="hidden" name="utm_source" value="<?php echo e(request()->get('utm_source', '')); ?>">
                <input type="hidden" name="utm_medium" value="<?php echo e(request()->get('utm_medium', '')); ?>">
                <input type="hidden" name="utm_campaign" value="<?php echo e(request()->get('utm_campaign', '')); ?>">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/show.blade.php ENDPATH**/ ?>