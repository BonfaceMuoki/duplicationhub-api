        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    <a href="<?php echo e(route('pages.index')); ?>" class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center">
                            <span class="text-white font-bold text-xl"><?php echo e(substr(config('app.name'), 0, 1)); ?></span>
                        </div>
                        <div>
                            <h1 class="text-xl font-bold text-gray-900"><?php echo e(config('app.name')); ?></h1>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="<?php echo e(route('pages.index')); ?>" class="text-gray-700 hover:text-blue-600 transition duration-200">Pages</a>
                    <!-- <a href="<?php echo e(route('pages.search')); ?>" class="text-gray-700 hover:text-blue-600 transition duration-200">Search</a> -->
                    <a href="#" class="text-gray-700 hover:text-blue-600 transition duration-200">About</a>
                    <a href="<?php echo e(route('pages.index')); ?>" class="text-gray-700 hover:text-blue-600 transition duration-200">Contact</a>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="<?php echo e(route('pages.index')); ?>" class="hover:text-white transition-colors">Pages</a></li>
                        <li><a href="<?php echo e(route('pages.search')); ?>" class="hover:text-white transition-colors">Search</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#" class="hover:text-white transition-colors">Business Growth</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Marketing</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">Strategy</a></li>
